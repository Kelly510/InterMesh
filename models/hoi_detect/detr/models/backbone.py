...
from models.hoi_detect.detr.util.misc import NestedTensor, is_main_process
...
def build_backbone(args):
    ...
    backbone = Backbone(args.hoi_backbone, train_backbone, return_interm_layers, args.dilation)
