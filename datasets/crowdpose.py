...
class CROWDPOSE(BASE):
    ...
    def get_raw_data(self, idx):
        ...
        for i in range(pnum):
            ...
            cam_intrinsics = torch.tensor([[cam_param['focal'][0], 0., cam_param['princpt'][0]], [0, cam_param['focal'][1], cam_param['princpt'][1]], [0, 0, 1]])
        ...
        raw_data = {'img_path': img_path, 'ds': 'crowdpose', 'pnum': len(betas), 'betas': betas, 'poses': poses, 'transl': transl, 'cam_intrinsics': cam_intrinsics, 'cam_rot': cam_rot, 'cam_trans': cam_trans, '3d_valid': False, 'detect_all_people': False}
